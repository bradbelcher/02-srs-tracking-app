...
class Tests(TransactionTestCase):
    ...
    def test_technicians_list(self):
        Technician.objects.create(first_name="first", last_name="last", id=1111)
    ...
    def test_technician_delete(self):
        technician = Technician.objects.create(first_name="first", last_name="last", id=1)
    ...
    def test_appointment_list(self):
        tech = Technician.objects.create(first_name="first", last_name="last", id=1)
    ...
    def test_appointment_cancel(self):
        ...
        response = client.put(f"/api/appointments/{appointment.id}/", json.dumps(body), content_type='application/json')
